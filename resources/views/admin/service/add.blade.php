        ...
        <div class="col-xl-6 col-lg-6 col-6  morning-sec ">
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <input class="form-control" type="number" name="min_guest" required min="1">
            </div>
            <div class="mb-3">
              <label class="col-form-label">Max Guest</label>
              <input class="form-control" type="number" name="max_guest" required min="1">
            </div>
        ...
        <div class="col-xl-6 col-lg-6 col-6  morning-sec ">
          <div class="card-body">
            <!-- <div class="mb-3">
                ...
                <input class="form-control" type="number" name="steps" value="" required min="1">
              </div> -->
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input class="form-control" type="number" name="weekend_price" value="" required>
            </div>
            <div class="mb-3">
